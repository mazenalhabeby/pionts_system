import { DocsTitle, DocsSubtitle, H2, H3, P, Code, Alert, Table, Endpoint } from './DocsComponents';
...
export function ApiCheckout() {
  return (
    <>
      <DocsTitle>API — Checkout</DocsTitle>
      <DocsSubtitle>Validate and manage loyalty discount codes at checkout.</DocsSubtitle>
      <P>{BASE}</P>
...
export function ApiOrders() {
  return (
    <>
      <DocsTitle>API — Orders</DocsTitle>
      <DocsSubtitle>Notify Pionts about order events to award or reverse points.</DocsSubtitle>
      <P>{BASE}</P>
...
export function ApiCustomers() {
  return (
    <>
      <DocsTitle>API — Customers</DocsTitle>
      <DocsSubtitle>Read customer data, redeem points, and manage redemptions.</DocsSubtitle>
      <P>{BASE}</P>
...
export function ApiConfig() {
  return (
    <>
      <DocsTitle>API — Config & Widget</DocsTitle>
      <DocsSubtitle>Project configuration and widget initialization.</DocsSubtitle>
      <P>{BASE}</P>
...
export function ApiWebhooks() {
  return (
    <>
      <DocsTitle>API — Webhooks</DocsTitle>
      <DocsSubtitle>Register endpoints for real-time event notifications.</DocsSubtitle>
      <P>{BASE}</P>
