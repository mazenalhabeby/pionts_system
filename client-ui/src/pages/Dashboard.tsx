            ...
            <div className="pw-hero__header">
              ...
              {isPartner && partnerInfo ? (
                <div className="pw-hero__balance">
                  <div className="pw-hero__points">&euro;{partnerInfo.credit_balance.toFixed(2)}</div>
                  <div className="pw-hero__label">Credit Balance</div>
                </div>
              ) : (
                <>
                  <div className="pw-hero__balance">
            ...
            {isPartner && partnerInfo ? (
              <>
                <div className="pw-stat stat-green">
                  <div className="pw-stat__number">&euro;{partnerInfo.total_earned.toFixed(2)}</div>
                  <div className="pw-stat__label">Total Earned</div>
                </div>
                <div className="pw-stat stat-blue">
                  <div className="pw-stat__number">{partnerInfo.commission_pct}%</div>
                  <div className="pw-stat__label">Commission</div>
                </div>
        ...
        {isPartner ? (
          <div className="pw-share">
            <div className="pw-share__top">
              ...
              <h2 className="pw-share__title">Your Partner Link</h2>
              <p className="pw-share__subtitle">Share to earn {partnerInfo?.commission_pct || 0}% commission on every purchase</p>
            </div>
            <div className="pw-share__body">
              ...
              <div className="pw-share__footer">
                ...
                <span className="pw-share__stat">
                  <span className="pw-share__stat-num">&euro;{partnerInfo?.total_earned.toFixed(2) || '0.00'}</span> earned
                </span>
              </div>
            </div>
          </div>
