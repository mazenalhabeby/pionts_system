import { Title, Subtitle, H2, H3, P, Step, Code, Alert, Table, Endpoint, Method } from '@/components/Docs';
...
export function GuideCustom() {
  return (
    <>
      ...
      <Subtitle>Full guide for Node.js, NestJS, Express, or any backend using the SDK.</Subtitle>
...
export function GuideShopify() {
  return (
    <>
      ...
      <Subtitle>Zero code required. Install the app and everything works automatically.</Subtitle>
...
export function GuideWooCommerce() {
  return (
    <>
      ...
      <Subtitle>WordPress theme snippet + WooCommerce webhooks.</Subtitle>
...
export function GuidePHP() {
  return (
    <>
      ...
      <Subtitle>For Laravel, Symfony, or raw PHP backends.</Subtitle>
...
export function GuidePython() {
  return (
    <>
      ...
      <Subtitle>For Django, Flask, FastAPI, or any Python backend.</Subtitle>
