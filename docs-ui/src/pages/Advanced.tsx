import { Title, Subtitle, H2, H3, P, Code, Alert, Table, Step } from '@/components/Docs';

export function DocsWidget() {
  return (
    <>
      <Title>Widget Setup</Title>
      <Subtitle>Add the floating loyalty widget to your storefront.</Subtitle>
...
export function DocsSecurity() {
  return (
    <>
      ...
      <Subtitle>Best practices for securing your Pionts integration.</Subtitle>
...
export function DocsErrors() {
  return (
    <>
      ...
      <Subtitle>Standard error format and SDK error classes.</Subtitle>
...
export function DocsSDK() {
  return (
    <>
      ...
      <Subtitle>Complete reference for @pionts/sdk.</Subtitle>
